...
@FhirType("TaskOutput", "BackboneElement")
export class TaskOutput extends BackboneElement {
  ...
  public static parse(
    json: ITaskOutput,
    providedInstance: TaskOutput = new TaskOutput()
  ): TaskOutput {
  ...
  public static isTaskOutput(input?: unknown): input is TaskOutput {
    const castInput = input as TaskOutput;
    return !!input && castInput.getTypeName && castInput.getTypeName() === "TaskOutput";
  }

  public toJSON(): ITaskOutput {
    const result: ITaskOutput = super.toJSON();
