...
export class ResearchDefinition extends DomainResource {
  ...
  public static parse(
    json: IResearchDefinition,
    providedInstance: ResearchDefinition = new ResearchDefinition()
  ): ResearchDefinition {
  ...
  public static isResearchDefinition(input?: unknown): input is ResearchDefinition {
    const castInput = input as ResearchDefinition;
    return !!input && castInput.getTypeName && castInput.getTypeName() === "ResearchDefinition";
  }

  public toJSON(): IResearchDefinition {
    const result: IResearchDefinition = super.toJSON();
