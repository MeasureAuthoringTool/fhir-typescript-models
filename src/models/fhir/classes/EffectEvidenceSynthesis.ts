...
export class EffectEvidenceSynthesis extends DomainResource {
  ...
  public clone(): EffectEvidenceSynthesis {
    return EffectEvidenceSynthesis.parse(this.toJSON());
  }
