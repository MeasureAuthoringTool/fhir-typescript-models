...
@FhirType("ElementDefinitionExample", "Element")
export class ElementDefinitionExample extends Element {
  ...
  public static parse(
    json: IElementDefinitionExample,
    providedInstance: ElementDefinitionExample = new ElementDefinitionExample()
  ): ElementDefinitionExample {
    const newInstance: ElementDefinitionExample = Element.parse(json, providedInstance);
  ...
  public static isElementDefinitionExample(input?: unknown): input is ElementDefinitionExample {
    const castInput = input as ElementDefinitionExample;
    return !!input && castInput.getTypeName && castInput.getTypeName() === "ElementDefinitionExample";
  }

  public toJSON(): IElementDefinitionExample {
    const result: IElementDefinitionExample = super.toJSON();
  ...
  public clone(): ElementDefinitionExample {
    return ElementDefinitionExample.parse(this.toJSON());
  }
